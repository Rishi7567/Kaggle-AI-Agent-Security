...
| `utility_probe.py` | The dimension no one measured: scores each guardrail on the **security × utility** frontier — attacks blocked *and* benign user-workflows preserved. Shows the strict guardrail that best resists attacks also breaks legitimate agent work. |
